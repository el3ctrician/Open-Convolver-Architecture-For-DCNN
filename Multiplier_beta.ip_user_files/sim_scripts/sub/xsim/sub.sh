...
#
# Generated by Vivado on Mon Jan 30 16:47:25 CET 2017
...
# Script info
echo -e "sub.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L c_reg_fd_v12_0_3 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_pipe_v3_0_3 -L xbip_dsp48_addsub_v3_0_3 -L xbip_addsub_v3_0_3 -L c_addsub_v12_0_10 -L xil_defaultlib -L secureip -L xpm --snapshot sub xil_defaultlib.sub -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim sub -key {Behavioral:sim_1:Functional:sub} -tclbatch cmd.tcl -log simulate.log
}
