...
#
# Generated by Vivado on Mon Jan 23 15:39:26 CET 2017
...
# Script info
echo -e "DSP_Mult.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xil_defaultlib -L secureip -L xpm --snapshot DSP_Mult xil_defaultlib.DSP_Mult -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim DSP_Mult -key {Behavioral:sim_1:Functional:DSP_Mult} -tclbatch cmd.tcl -log simulate.log
}
